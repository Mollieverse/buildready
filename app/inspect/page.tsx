        ...
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          <div style={{ marginBottom: 32 }}>
            ...
            <p style={{ color: C.muted, fontSize: 15 }}>
              Paste your software build prompt and get a detailed readiness report.
            </p>
          </div>
          <div
            style={{
          ...
          >
            ...
            >
              <span
                style={{
                  color: prompt.length > MAX * 0.9 ? C.orange : C.dim,
                  fontSize: 13,
                }}
              >
                {prompt.length}/{MAX}
              ...
              <button
                ...
                style={{
                  ...
                  opacity: loading || prompt.trim().length < 30 ? 0.5 : 1,
                }}
              >
    ...
    >
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
            ...
            <div style={{ display: "flex", gap: 8 }}>
              ...
              <span
                style={{
                  ...
                  fontSize: 11,
                  fontWeight: 600,
                  background: (result.readyToBuild ? C.green : C.orange) + "18",
                  color: result.readyToBuild ? C.green : C.orange,
                  border:
                    "1px solid " +
                    (result.readyToBuild ? C.green : C.orange) +
                    "30",
                }}
              >
        ...
        {detailFailed && (
          ...
          >
            Detailed breakdown timed out. Your scores above are complete and
            accurate.
          </div>
        )}
          ...
          >
            ...
            <div
              style={{
                fontSize: 48,
                fontWeight: 800,
                color: scoreColor(clamp(result.overallScore, 0, 100) / 10),
                textAlign: "center",
                marginBottom: 24,
              }}
            >
              {clamp(result.overallScore, 0, 100)}
              ...
              Object.entries(result.aiCompatibility).map(([ai, val]: any) => (
                <div key={ai} style={{ marginBottom: 10 }}>
                  ...
                  >
                    ...
                    <span style={{ fontSize: 13, color: scoreColor(val / 10) }}>
                      {val}%
                    </span>
                  </div>
                  <div
          ...
          {[
            ...
            <button
              ...
              style={{
                ...
                border: "none",
                borderBottom:
                  "2px solid " + (activeTab === id ? C.blue : "transparent"),
              ...
              >
                ...
                {cat.strengths?.length > 0 && (
                  <div style={{ marginTop: 10 }}>
                    ...
                    {cat.strengths.map((s: string) => (
                      <div
                        key={s}
                        style={{ fontSize: 12, color: C.muted, marginBottom: 3 }}
                      >
                        {s}
                      </div>
                    ))}
                ...
                {cat.recommendations?.length > 0 && (
                  <div style={{ marginTop: 10 }}>
                    ...
                    {cat.recommendations.map((s: string) => (
                      <div
                        key={s}
                        style={{ fontSize: 12, color: C.muted, marginBottom: 3 }}
                      >
        ...
        {activeTab === "simulation" && (
          ...
          >
            {[
              {
                label: "Will Build Correctly",
                color: C.green,
                items: result.simulation?.willBuildCorrectly || [],
              },
              {
                label: "Potential Misunderstandings",
                color: C.orange,
                items: result.simulation?.potentialMisunderstandings || [],
              },
              {
                label: "Missing Assumptions",
                color: C.blue,
                items: result.simulation?.missingAssumptions || [],
              },
              {
                label: "Implementation Risks",
                color: C.red,
                items: result.simulation?.implementationRisks || [],
              },
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: 6,
                  fontSize: 12,
                  cursor: result.improvedPrompt ? "pointer" : "not-allowed",
                  opacity: result.improvedPrompt ? 1 : 0.5,
                }}
              >
                {copied ? "Copied" : "Copy"}
              </button>
